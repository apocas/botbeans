...
import org.botbeans.blocks.workspace.typeblocking.FocusTraversalManager;
import org.botbeans.blocks.workspace.typeblocking.TypeBlockManager;
import org.botbeans.blocks.Block;
import org.botbeans.blocks.util.Explorer;
import org.botbeans.blocks.util.ExplorerEvent;
import org.botbeans.blocks.util.ExplorerListener;
...
public class Workspace extends JLayeredPane implements ISupportMemento, RBParent, ChangeListener, ExplorerListener {
    ...
    public WorkspaceWidget getWidgetAt(Point point) {
        ...
        if (factory.contains(
                ...
                SwingUtilities.convertPoint((JComponent) ws, point, factory.getJComponent()).y)) {
            return factory;
        }
    ...
    public String getSaveString() {
        ...
        System.out.println("Teste: " + saveString.toString());
