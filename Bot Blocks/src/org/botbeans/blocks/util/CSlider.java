...
public class CSlider extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.startMark) {
            ...
            g2.setFont(font);
            g2.drawString(startMarkLabel, convertToPixels(this.thumbStart) - (textWidth / 2), (int) (blueprint.trackBottom * 1.7));
        }
    ...
    private int convertToAbstract(int value) {
        ...
        return this.left + Math.round((value - blueprint.closeTrackEdgeLeft) * (this.right - this.left) / (i == 0 ? 1 : i));
    }
    ...
    private int convertToPixels(int value) {
        ...
        return blueprint.closeTrackEdgeLeft
                + Math.round((value - this.left) * (blueprint.closeTrackEdgeRight - blueprint.closeTrackEdgeLeft) / (i == 0 ? 1 : i));
    }
